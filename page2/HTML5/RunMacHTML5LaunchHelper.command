...
EPIC_MONO=""
if [ -f "C:\dev\UE_4.21\Engine\Build\BatchFiles\Mac\SetupMono.sh" ]; then
    pushd "C:\dev\UE_4.21\Engine\Build\BatchFiles\Mac"
	source SetupMono.sh
    popd
else
	EPIC_MONO="NOTE: It seems this $0 was built from another platform and copied here.\nNOTE: Was expecting to setup mono via: "'C:\dev\UE_4.21\Engine\Build\BatchFiles\Mac\SetupMono.sh';
fi
