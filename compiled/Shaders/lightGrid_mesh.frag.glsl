...
void main() {
	...
	vec3 TextureCoordinate_texread_Object_res = mposition;
	TextureCoordinate_texread_Object_res = (TextureCoordinate_texread_Object_res);
	vec4 ImageTexture_texread_store = texture(ImageTexture, vec2(TextureCoordinate_texread_Object_res.x, 1.0 - TextureCoordinate_texread_Object_res.y).xy);
